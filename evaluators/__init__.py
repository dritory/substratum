...
EVALUATORS: dict[str, str] = {
    ...
    "ckm_wolfenstein_lambda_hierarchy": "evaluators.pattern_compression",
    ...
    "neutrino_mass_scale_seesaw": "evaluators.pattern_compression",
    ...
    "quark_mass_fn_compression": "evaluators.pattern_compression",
